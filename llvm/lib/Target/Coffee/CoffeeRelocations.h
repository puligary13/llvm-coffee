//===-- CoffeeRelocations.h - Coffee Code Relocations -----------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the Coffee 32-bit target-specific relocation types.
//
//===----------------------------------------------------------------------===//

#ifndef CoffeeRELOCATIONS_H
#define CoffeeRELOCATIONS_H

#include "llvm/CodeGen/MachineRelocation.h"

// Hack to rid us of a Coffee pre-processor symbol which is erroneously
// defined in a Coffee header file (bug in Linux/Coffee)
#ifdef Coffee
#undef Coffee
#endif
