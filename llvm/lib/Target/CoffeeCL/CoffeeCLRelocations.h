//===-- CoffeeCLRelocations.h - CoffeeCL Code Relocations -----------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the CoffeeCL 32-bit target-specific relocation types.
//
//===----------------------------------------------------------------------===//

#ifndef CoffeeCLRELOCATIONS_H
#define CoffeeCLRELOCATIONS_H

#include "llvm/CodeGen/MachineRelocation.h"

// Hack to rid us of a CoffeeCL pre-processor symbol which is erroneously
// defined in a CoffeeCL header file (bug in Linux/CoffeeCL)
#ifdef CoffeeCL
#undef CoffeeCL
#endif
