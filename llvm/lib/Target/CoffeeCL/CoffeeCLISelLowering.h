//===-- CoffeeCLISelLowering.h - CoffeeCL32 DAG Lowering Interface --------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the interfaces that CoffeeCL uses to lower LLVM code into a
// selection DAG.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_TARGET_CoffeeCL_CoffeeCL32ISELLOWERING_H
#define LLVM_TARGET_CoffeeCL_CoffeeCL32ISELLOWERING_H
...
class CoffeeCLTargetLowering : public TargetLowering {

public:
    explicit CoffeeCLTargetLowering(CoffeeCLTargetMachine &TM);
...
private:
    ...
    class CoffeeCLCC {
    public:
      CoffeeCLCC(CallingConv::ID CallConv, bool IsVarArg,
             CCState &Info);
    ...
    SDValue getCoffeeCLCmp(SDValue LHS, SDValue RHS, SelectionDAG &DAG,
                                 DebugLoc dl) const;
    ...
    /// argument.
    void writeVarArgRegs(std::vector<SDValue> &OutChains, const CoffeeCLCC &CC,
                         SDValue Chain, DebugLoc DL, SelectionDAG &DAG) const;

};
}

#endif   // LLVM_TARGET_CoffeeCL_CoffeeCL32ISELLOWERING_H
