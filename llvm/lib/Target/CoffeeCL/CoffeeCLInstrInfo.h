//===-- CoffeeCLInstrInfo.h - CoffeeCL Instruction Information --------*- C++ -*-===//
//
...
#ifndef CoffeeCL_INSTRUCTIONINFO_H
#define CoffeeCL_INSTRUCTIONINFO_H
...
class CoffeeCLInstrInfo : public CoffeeCLGenInstrInfo {
  CoffeeCLTargetMachine &TM;
  const CoffeeCLRegisterInfo RI;
  unsigned UncondBrOpc;

public:
  explicit CoffeeCLInstrInfo(CoffeeCLTargetMachine &TM);

  virtual const CoffeeCLRegisterInfo &getRegisterInfo() const { return RI;}
